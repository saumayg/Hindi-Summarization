...
class Rouge(evaluate.Metric):
    ...
    def _compute(
        self, predictions, references, rouge_types=None, use_aggregator=True, use_stemmer=False, tokenizer=None, language="hindi"
    ):
        ...
        scorer = rouge_scorer.RougeScorer(rouge_types=rouge_types, use_stemmer=use_stemmer, tokenizer=tokenizer, language=language)
        if use_aggregator:
